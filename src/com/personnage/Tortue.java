...
public class Tortue extends Personnage implements Runnable{
	...
	private int dxTortue; // pas de dÈplacement du champignon
	...
	//**** METHODES ****//	
	public void bouge(){ // DÈplacement du champignon
	...
	@Override
	public void run() {
		try{Thread.sleep(20);} // on attend 20 ms avant d'appeler bouge pour que tous les objets soient complËtement crÈÈs
